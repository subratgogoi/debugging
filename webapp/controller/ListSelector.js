sap.ui.define([
		...
		return BaseObject.extend("spde.model.ListSelector", {
			 ...
			 * @return {spde.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
